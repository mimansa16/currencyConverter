...
function App() {
  ...
  const currencyInfo = useCurrencyInfo(from); //jisko convert karna hai vo vala object from data that is coming from our hook
  const options = Object.keys(currencyInfo); // extracting key from the chosen hook coz thats what we need
              ...
              <div className="relative w-full h-0.5">
                <button
                  ...
                  className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 border-white
                   rounded-md bg-gray-700 text-white px-2 py-0.5"
                   onClick={swap}
                >
                  swap
                </button>
